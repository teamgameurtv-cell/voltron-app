              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        profile.name.isNotEmpty ? profile.name : 'Mon compte',
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        activePlan != null
                            ? 'Voltron Care ${activePlan.name} actif'
                            : 'Aucun abonnement Voltron Care',
                        style: const TextStyle(
        ...
        child: Row(
          children: [
            Icon(
              item.icon,
              size: 20,
              color: destructive ? color : VoltronColors.greyText,
            ),
            const SizedBox(width: 14),
            Expanded(
              child: Text(
