...
class _ClientDetail extends ConsumerWidget {
            ...
            ...scooters.map(
              (v) => Material(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(VoltronRadii.md),
                  onTap: () =>
                      _showVehicleRepairsDialog(context, ref, clientId, v),
                  child: Container(
  ...
  void _showVehicleRepairsDialog(
    BuildContext context,
    WidgetRef ref,
    String clientId,
    OwnedScooter vehicle,
  ) {
    final scooterName = '${vehicle.brand} ${vehicle.model}';
    final orders = ref
        .read(repairsProvider)
        .where((o) => o.clientId == clientId && o.scooterName == scooterName)
        .toList();
